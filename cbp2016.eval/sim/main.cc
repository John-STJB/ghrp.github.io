...
//          }
          ...
          // printf("PC: %llx Physaddr: %llx type: %x T %d N %d outcome: %d\n", PC,PhysAddr, (UINT32)opType, it->getSrcNode()->brObservedTakenCnt(), it->getSrcNode()->brObservedNotTakenCnt(), branchTaken);
